<template>
  <div id="apdialogs" style="display: block;" v-if="showEditUserDialog">
                  ...
                  <div class="form form-dialog form-inline">
                    <form @submit.prevent="handleUpdateMyProfile">
                      ...
                      <div class="row -isfake">
                        ...
                        <div class="input data">
                          <div class="input-fake ap-xdot">{{ myProfile.email }}</div>
                        </div>
                        <div class="clear"></div>
                      </div>
                      <div class="row -isfake">
...
export default {
  ...
  watch: {
    myProfile(myProfile) {
      ...
      this.position = myProfile.position;
      this.birthday = myProfile.birthday ? new Date(myProfile.birthday) : "";
  ...
  computed: {
    getAvatar() {
      if (this.myProfile && this.avatar.base64URL === "") {
  ...
  methods: {
    ...
    hideEditUserDialog() {
      ...
      this.position = this.myProfile.position;
      this.birthday = this.myProfile.birthday;
