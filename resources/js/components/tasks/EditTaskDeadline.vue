          ...
          <div id="ie-body" class="ie-body" style="top: 0px; left: -30px;">
            <div class="cform">
              ...
              <div class="extra">
                ...
                <div class="row">
                  <input type="hidden" name="id" value="1980121" />
                  <input type="hidden" name="key" value="deadline" />
                  <div class="input __timeselectw">
                    <vue-timepicker v-model="time" />
                    <div
                      class="__hiddenselect"
...
export default {
  ...
  methods: {
    ...
    handleUpdateTaskDeadline(isNullDeadline = false) {
      let date = this.date ? moment(this.date).format("YYYY-MM-DD") : "";
      let { time } = this;
      time = time ? time : "23:59";
      if (isNullDeadline) this.date = "";
      let due_on = date ? date + " " + time : "";
